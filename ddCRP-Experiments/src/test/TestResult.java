...
public class TestResult {
	...
	{
		String delim = ",";
		String resultLine = sample.getObsCategory()+delim+sample.getListIndex()+delim+sample.getObsIndex()+correctCategoryPredictionMultAll+delim+correctCategoryPredictionMultEach+delim+correctCategoryPredictionProb+delim;
        resultLine = resultLine + predictedCategory+delim+isPredictedCategoryCorrect+delim+correctCategoryPredictionProbMAP+delim+predictedMAPCategory+delim+isPredictedMAPCategoryCorrect+delim;
        resultLine = resultLine + inTopTen+delim+inTopTenEach+delim+inTopTenAll+delim+baseLineProb+delim+correctLocationPredictionProb+delim+predictedLocation+isPredictedLocationCorrect;
        resultLine = resultLine + predictedMAPLocation+delim+isPredictedMAPLocationCorrect+delim+doWeBeatLocationBaseline+delim+doWeBeatLocationBaselineMAP;
		
		out.println(resultLine);
		//out.println(sample.getObsCategory()+delim+sample.getListIndex());
	}
